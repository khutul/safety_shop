const ITEMS = [
  { t: "Брэнд бараа", s: "Албан ёсны баталгаатай", d: "M12 3l7 3v6c0 4-3 7-7 9-4-2-7-5-7-9V6z M9 12l2 2 4-4" },
  { t: "Шуурхай хүргэлт", s: "Улаанбаатар хотод 24ц", d: "M3 7h11v8H3z M14 10h4l3 3v2h-7z M7 17a2 2 0 1 0 0-.01 M17 17a2 2 0 1 0 0-.01" },
  { t: "Чанарын баталгаа", s: "Олон улсын стандартад нийцсэн", d: "M12 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10z M8 13l-2 7 6-3 6 3-2-7" },
